...
import { classifyFeedbackText, ClassificationSchema } from "../src/lib/aiService";
import { parseFeedbackCsv } from "../src/lib/csvParser";
import { askLoopRag, searchWorkspaceEmbeddings, generateEmbeddingVector } from "../src/lib/vectorRagService";
import { calculateVerifiedStats, generateVocReportContent } from "../src/lib/reportService";
...
async function runMasterSecuritySuite() {
  ...
  try {
    ...
    try {
      ...
      if (!allowedRoles.includes(viewerA.role)) {
